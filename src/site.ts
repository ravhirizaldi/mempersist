...
.nav-toggle{display:none;border:1px solid var(--line);background:var(--surface);border-radius:4px;padding:9px 14px;font-size:13px;color:var(--ink);position:relative;z-index:13;transition:border-color .2s}
